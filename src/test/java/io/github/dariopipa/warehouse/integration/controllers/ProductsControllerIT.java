...
class ProductsControllerIT {
    ...
    void test_CreateProduct_ShouldSaveEntityToDatabase() {
        ...
        ResponseEntity<Void> response = restTemplate.exchange(
                "/api/v1/products", HttpMethod.POST, entity, Void.class);
    ...
    void test_GetProduct_ShouldReturnProductGetOneResponseDTO() {
        ...
        ResponseEntity<ProductGetOneResponseDTO> response = restTemplate.exchange(
                "/api/v1/products/" + productId, HttpMethod.GET, entity, ProductGetOneResponseDTO.class);
    ...
    void test_UpdateProduct_ShouldUpdateEntity() {
        ...
        ResponseEntity<Void> response = restTemplate.exchange(
                "/api/v1/products/" + productId, HttpMethod.PATCH, entity, Void.class);
    ...
    void test_UpdateQuantity_ShouldUpdateTheProductQuantityBasedOnOperation() {
        ...
        ResponseEntity<Void> response = restTemplate.exchange(
                "/api/v1/products/" + productId + "/quantity", HttpMethod.PATCH, entity, Void.class);
    ...
    void test_DeleteProduct_ShouldSoftDeleteFromDatabase() {
        ...
        ResponseEntity<Void> response = restTemplate.exchange(
                "/api/v1/products/" + productId, HttpMethod.DELETE, entity, Void.class);
    ...
    void test_GetProducts_ShouldReturnPagedResults() {
        ...
        ResponseEntity<String> response = restTemplate.exchange(
                "/api/v1/products?page=0&size=10", HttpMethod.GET, entity, String.class);
    ...
    void test_CreateProduct_WithInvalidData_ShouldReturnBadRequest() {
        ...
        ResponseEntity<String> response = restTemplate.exchange(
                "/api/v1/products", HttpMethod.POST, entity, String.class);
    ...
    private String authenticateAndGetToken() {
        ...
        ResponseEntity<JwtResponse> response = restTemplate.exchange(
                "/api/v1/auth/login", HttpMethod.POST, entity, JwtResponse.class);
